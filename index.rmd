...
library(pacman)
p_load(tidyverse, esquisse, dlookr, rio, here, readr, tidytext, knitr, janitor, expss, hrbrthemes, flextable, labelled, sjlabelled, colorblindr, forcats, treemap, flexdashboard, treemap, plotly, ragg, extrafonts, ggiraph)
...
### **Guides to Reading Maps (37 States of Nigeria)** {.no-title}

**Guides to Maps (37 States of Nigeria)**
```{r, warning=FALSE}
gg <- ggplot(NGA1)+
 geom_sf() +
  theme_void() +
   geom_sf_text_interactive(aes(label = NAME_1, tooltip = NAME_1))
gg
...
# General Media Use {data-orientation="rows" data-icon="ion-android-desktop"}
