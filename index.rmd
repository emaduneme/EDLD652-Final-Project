...
library(pacman)
p_load(tidyverse, esquisse, dlookr, rio, here, readr, tidytext, knitr, janitor, expss, hrbrthemes, flextable, labelled, sjlabelled, colorblindr, forcats, treemap, flexdashboard, treemap, plotly, ragg)
...
```{r warning=FALSE}
 ggplotly(Trust_President_plot)
```

### Trust in Religious Leaders by State

```{r warning=FALSE}
 ggplotly(Trust_Religious_Leaders_plot)
```
