...
library(pacman)
p_load(tidyverse, esquisse, dlookr, rio, here, readr, tidytext, knitr, janitor, expss, hrbrthemes, flextable, labelled, sjlabelled, colorblindr, forcats, treemap, flexdashboard, treemap, plotly, ragg, extrafonts, ggiraph, tmap)
...
tablaeu2 <- tablaeu %>%
  mutate(Ratings = as.numeric(ratings_c),
         NAME_1 = as.character(state)) %>% 
  select(3, 6, 7)
